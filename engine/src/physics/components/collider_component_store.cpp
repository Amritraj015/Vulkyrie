...
namespace Vulkyrie {
    ...
    ColliderComponentStore::ColliderComponentStore() {
        ...
        _collisionPairs.reserve(INITIAL_COMPONENT_RESERVATION_COUNT);
    ...
    void ColliderComponentStore::swapComponents(size_t indexA, size_t indexB) {
        ...
        std::swap(_collisionPairs[indexA], _collisionPairs[indexB]);
