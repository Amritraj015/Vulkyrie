...
namespace Vulkyrie {
    ...
    //         // Recompute the inverse mass matrix K=JM^-1J^t for the 3 translational constraints.
    ...
    //             const glm::vec3 lambda = _basStore.GetInverseMassMatrixAtIndex(i) * (-constraintError);
