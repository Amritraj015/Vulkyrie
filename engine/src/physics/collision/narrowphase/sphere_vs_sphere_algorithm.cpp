...
namespace Vulkyrie {
    ...
    bool SphereVsSphereAlgorithm::PerformCollisionCheck(NarrowPhaseDataBatch &batch, size_t batchStartIndex, size_t batchItemsCount) {
            ...
            if (distanceSquared < radiusSumSquared) {
                ...
                if (penetrationDepth > f32(0.0)) {
                    ...
                    if (data.ReportContacts) {
                        ...
                        batch.AddContactPoint(i, contactNormal, penetrationDepth, intersectionBodyOne, intersectionBodyTwo);
                    }
