...
V_API void *_darray_create(u64 length, u64 stride);
V_API void _darray_destroy(void *array);

V_API u64 _darray_field_get(void *array, u64 field);
V_API void _darray_field_set(void *array, u64 field, u64 value);
...
V_API void *_darray_pop_at(void *array, u64 index, void *dest);
V_API void *_darray_insert_at(void *array, u64 index, void *value_ptr);
