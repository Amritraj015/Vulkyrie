...
namespace Vulkyrie {
    ...
    // The frame graph is not wired into this backend yet, so nothing here instantiates FrameGraph<VulkanBackend>.
    ...
    static_assert(FrameGraphResourceType<FrameGraphTexture<VulkanBackend>, VulkanBackend>,
                  "FrameGraphTexture does not satisfy the frame graph resource concept for VulkanBackend.");
    static_assert(FrameGraphResourceType<FrameGraphBuffer<VulkanBackend>, VulkanBackend>,
                  "FrameGraphBuffer does not satisfy the frame graph resource concept for VulkanBackend.");
