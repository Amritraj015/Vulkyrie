...
namespace Vulkyrie {
    ...
    public:
        ...
        [[nodiscard]] VE_INLINE f32 GetFrictionCoefficientSquareRoot() const {
        ...
        [[nodiscard]] VE_INLINE f32 GetFrictionCoefficient() const {
         ...
         * two surfaces in contact. The friction coefficient must be a non-negative value, as negative friction does not make physical sense. This property
         * is crucial for accurate physics simulations, as it affects how objects interact with each other and respond to forces. */
        VE_INLINE void SetFrictionCoefficient(f32 frictionCoefficient) {
        ...
        [[nodiscard]] VE_INLINE f32 GetRestitutionCoefficient() const {
         ...
         * initial velocities. */
        VE_INLINE void SetRestitutionCoefficient(f32 restitutionCoefficient) {
        ...
        [[nodiscard]] VE_INLINE f32 GetDensity() const {
            return _density;
        }
        ...
        VE_INLINE void SetDensity(f32 density) {
