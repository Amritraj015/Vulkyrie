...
namespace Vulkyrie {
    ...
    public:
        ...
        [[nodiscard]] VE_INLINE constexpr bool IsPolyhedral() const override {
            return false;
        }
        ...
        [[nodiscard]] VE_INLINE glm::vec3 GetLocalSupportPointWithoutMargin([[maybe_unused]] const glm::vec3 &direction) const override {
