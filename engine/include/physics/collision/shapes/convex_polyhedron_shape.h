...
namespace Vulkyrie {
    ...
    public:
         ...
         * @return The number of faces of the convex polyhedron shape. This is typically equal to the number of flat surfaces that make up the shape.
         */
        virtual u32 GetFacesCount() const = 0;

        /** @brief Get the number of vertices of the convex polyhedron shape.
         * @return The number of vertices of the convex polyhedron shape. This is typically equal to the number of corners or points where edges meet on the
         * shape.
         */
        virtual u32 GetVerticesCount() const = 0;

        /** @brief Get the number of half edges of the convex polyhedron shape.
         * @return The number of half edges of the convex polyhedron shape. This is typically equal to twice the number of edges, since each edge is
         ...
         * @return The centroid of the convex polyhedron shape as a glm::vec3. The centroid is the geometric center of the shape, calculated as the average
