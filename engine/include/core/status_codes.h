...
namespace Vulkyrie {
    ...
    enum class StatusCode : int32_t {
        ...
        FailedToCreateVulkanObjectDebugName,
        FailedToGetVulkanGraphicsQueue,
        FailedToGetVulkanTransferQueue,
        FailedToGetVulkanComputeQueue,
        ...
        FailedToQueryPhysicalDevicePresentModes,
        RequiredSwapchainSurfaceFormatNotSupported,
        RequiredSwapchainImageUsageNotSupported,
        RequiredSwapchainCompositeAlphaNotSupported,
        InvalidSizeForVulkanSwapchain,
        FailedToCreateVulkanSwapchain,
        FailedToGetVulkanSwapchainImages,
        FailedToCreateVulkanSwapchainImageView,
        FailedToCreateVulkanPresentSemaphore,
        FailedToCreateVulkanAcquireSwapchainImageSemaphore,
