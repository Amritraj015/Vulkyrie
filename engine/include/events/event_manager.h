...
//
//         public:
//             EventSystemManager(const EventManager &) = delete;
//             void operator=(EventManagerconst &) = delete;
//
//             /**
//              * Registers an event.
...
//              */
//             static bool Dispatch(Event *event, SenderType senderType = SenderType::Anonymous,
//                                  ListenerType listenerType = ListenerType::All);
//     };
// } // namespace Engine
