                ...
                dispatcher.Dispatch<KeyPressedEvent>([this](const KeyPressedEvent &e) {
                    ...
                    if (e.KeyCode == KeyCode::J) {
                        if (currentLayer == 0) {
                            ...
                            _application.PushLayer<PongLayerBackPack>(windowWidth, windowHeight);
                        } else if (currentLayer == 1) {
                            _application.PopLayer<PongLayerBackPack>();
                            _application.PushLayer<PongLayerPlanet>(windowWidth, windowHeight);
                        } else if (currentLayer == 2) {
                            _application.PopLayer<PongLayerPlanet>();
